...
if (!isset($_SESSION['user_id'])) {
    if (isset($_POST['submit'])) {
        ...
        if ($_POST['user'] != "" AND $_POST['email'] != "") {
            ...
            $stmt->execute();
            $stmt->bind_result($rij_dbid, $rij_dbemail);

            if ($stmt->fetch()) {
                // Emailcheck
                $dbemail = htmlspecialchars($rij_email);
...
EOF;
                    ...
                    echo "Het gegeven e-mailadres komt niet overeen met het e-mailadres voor '{$_POST['user']}' in de database.<br /><a href=\"javascript:history.back()\">&laquo; Ga terug</a>";
                }
            } else {
                $stmt->close();
